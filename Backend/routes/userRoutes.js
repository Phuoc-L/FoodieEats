...
// Removed Restaurant model import as it's not needed here
...
router.post("/signup", async (req, res) => {
  // Reverted signup logic to handle ONLY personal users
  try {
    // Only expect standard user data
    const { password, ...userData } = req.body; 
    const hashedPassword = await hashPassword(password);

    // Create a standard user document without owner fields
